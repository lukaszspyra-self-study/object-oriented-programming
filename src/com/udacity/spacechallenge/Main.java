...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print("Total budget required for both phases, using U1 rockets: ");
        System.out.println(simulation.runSimulation(phase1_U1rockets) + simulation.runSimulation(phase2_U1rockets) + " Million $.");
        ...
        System.out.print("Total budget required for both phases, using U2 rockets: ");
        System.out.println(simulation.runSimulation(phase1_U2rockets) + simulation.runSimulation(phase2_U2rockets) + " Million $.");
    }
}
